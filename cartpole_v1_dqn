...
if __name__ == "__main__":
    ...
    # Loads the weights
    if os.path.isfile("cartpole-v1.weights.h5"):
        agent.load_weights("cartpole-v1.weights.h5")
    ...
    for episode in range(num_episodes):
        ...
        if total_reward >= max_reward:
            agent.save_weights("cartpole-v1.weights.h5")
    ...
    plt.title('DQN CartPole: Reward vs. Episode (100 Episodes)')
    plt.legend()
    ...
    print("Plot saved as 'cartpole_training.png'. Open it to view the graph!")
